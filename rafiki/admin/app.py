...
from rafiki.admin.view.events import events_bp
from rafiki.admin.view.inference_job import inference_bp
from rafiki.admin.view.user import user_bp
from rafiki.admin.view.datasets import dataset_bp
from rafiki.admin.view.model import model_bp
from rafiki.admin.view.train_jobs import trainjob_bp
from rafiki.admin.view.trials import trial_bp
