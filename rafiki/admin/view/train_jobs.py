...
from rafiki.constants import UserType, RequestsParameters, BudgetOption
...
@auth([UserType.ADMIN, UserType.MODEL_DEVELOPER, UserType.APP_DEVELOPER])
@param_check(required_parameters=RequestsParameters.TRAIN_GETBY_USER)
def get_train_jobs_by_user(auth, params):
    ...
    with admin:
        return jsonify(admin.get_train_jobs_by_user(user_id=params['user_id']))
