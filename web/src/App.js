  ...
  render() {
    return (
      <Switch>
        ...
        <Route exact path="/sign-in" component={SignInLoadable} />
        <Route exact path="/sign-up" component={SignUpLoadable} />
        <Route path="/console" component={ConsoleAppFrameLoadable} />
