...
from rafiki.custom_models_base.darknet import darknet
            ...
            with tempfile.TemporaryDirectory() as d:
                ...
                for file_name in os.listdir(d):
                    if "yolo" in file_name:
                        self.det_net = darknet.load_net(b"./rafiki/custom_models_base/darknet/cfg/food/yolov3-food.cfg",
                                                        os.path.join(d, file_name).encode(), 0)

                        self.det_meta = darknet.load_meta(b"./rafiki/custom_models_base/darknet/cfg/food/food.data")
